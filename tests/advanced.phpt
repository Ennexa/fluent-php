...
try {
    ...
    $response = $bundle->formatPattern('log-time', [
        'date' => new \DateTimeImmutable('2023-03-22T12:00:00'),
        'deadline' => new \DateTimeImmutable('2023-03-23'),
        'user' => (object)['name' => 'John Doe'],
    ]);
    // Output: User John Doe logged in at 2023-03-22 12:00:pm before deadline.
...
===DONE===
--EXPECT--
User John Doe logged in at 2023-03-22 12:00 pm before deadline.
===DONE===
